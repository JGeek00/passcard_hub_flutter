...
class Pass {
  ...
  /// Save pass file from local pkpass file to internal memory, parse and return [PassFile]
  Future<PassFile> saveFromFile({required File file}) async {
    return PassFileIO().saveFromFile(file: file);
  }
